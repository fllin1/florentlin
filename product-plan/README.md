# Florent Lin — Design Handoff

This folder contains everything needed to implement Florent Lin's portfolio website.
...
|---------|------------|-------------|
| Hero | `Hero.tsx` | Personal introduction with name, title, and tagline |
| About | `About.tsx`, `AspirationCard.tsx`, `HobbyCard.tsx` | Aspirations, hobbies, and personality |
| Experience & Skills | `ExperienceSkills.tsx`, `ExperienceCard.tsx`, `EducationCard.tsx`, `SkillCategory.tsx`, `GitHubButton.tsx` | Professional background and technical expertise |
| Contact | `Contact.tsx`, `ContactLink.tsx` | Contact links (email, LinkedIn, GitHub) |
